...
const Cart = () => {
  ...
  const handleConfirmClick = async () => {
    const orderData = {
      userId: user._id, // Assurez-vous que l'ID de l'utilisateur est disponible
  ...
  return (
    <div className="container ms-auto p-4" style={{paddingTop:"70px", paddingBottom:"70px"}}>
      ...
      {alertVisible && (
        <div
          className="absolute bottom-16 left-0 w-full p-4 bg-green-600 text-white text-center rounded-t-md shadow-md"
