...
const ProductDetail = () => {
  ...
  const [productData, setProductData] = useState({
    ...
    price: "",
    sellingPrice: "",
    stockQuantity: 0,  // Ajouter la quantité en stock
  ...
  return (
    <div className="container mx-auto p-4 mt-6" style={{paddingTop:"70px", paddingBottom:"70px"}}>
        ...
        <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              <StockStatus className={`stock-status ${productData.stock > 0 ? 'in-stock' : 'out-of-stock'}`}>
        {productData.stock > 0 ? "In Stock" : "Out of Stock"}
      </StockStatus>
              <div className="flex items-center gap-3 my-2 text-xl font-bold">
                <button className="border-2 bg-green-600 hover:bg-gray-900 text-white rounded px-3 py-1 min-w-[150px] flex items-center justify-center">
                  <FaBolt className="mr-2" /> Buy Now
                </button>
                <button
  className="border-2 bg-orange-600 hover:bg-gray-900 text-white rounded px-3 py-1 min-w-[150px] flex items-center justify-center"
  onClick={(e) => addToCart(e, productData?._id, productData.stock)} // Passe le stock ici
>
